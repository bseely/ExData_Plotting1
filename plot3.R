## Script to make Plot 3 and save to a PNG file
...
## Make Energy Sub Metering chart, export to PNG
...
dev.copy(png, file="./figure/plot3.png",width = 480, height = 480,units = "px", pointsize = 12, bg = "white", res = NA,
         restoreConsole = TRUE)
dev.off()
