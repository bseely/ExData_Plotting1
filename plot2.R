## Script to make Plot 2 and save to a PNG file
...
## Make Global Active Power time series chart, export to PNG
...
dev.copy(png, file="./figure/plot2.png",width = 480, height = 480,units = "px", pointsize = 12, bg = "white", res = 72,
         restoreConsole = TRUE)
dev.off()
